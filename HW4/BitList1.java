...
//=========================== Intro2CS 2021, ASSIGNMENT 4, TASK 2.1 ================================================
    ...
    public String toString() {
        //String output = "<";
    	//Object[] bitsArray = super.toArray();
	    //for (int i=bitsArray.length-1; i>=0; i=i-1) {
	    //	output = output + bitsArray[i];
	    //}
	    //output = output + ">";
	    //return output;
    	
    	String output = super.toString(); // getting the string removing < and > chars and then reversing the result and then adding < >
    ...
    public boolean isReduced() {
        ...
        str = str.replace("<", "");
        str = str.replace(">", "");
        boolean a = (str.equals("0") | str.equals("01") | str.equals("11")); // a condition
        boolean b = super.size() > 2 && ( str.substring(0,2).equals("01") | str.substring(0,2).equals("10"));// b condition
        boolean c = super.size() > 2 && numberOfOnes == 2 & str.substring(0,2).equals("11");// c condition
        ans = ans & ( a | b | c);
        return ans;
    }

    public void reduce() {
    	while(!isReduced() & super.size() > 0) { // removing the last element until we get true from isReduced function
    		removeLast();
        }
    }

    //=========================== Intro2CS 2021, ASSIGNMENT 4, TASK 2.6 ================================================
    public BitList complement() { // return a bitlist with negtated bit list values
